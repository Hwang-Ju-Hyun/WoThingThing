...
{
	CongratulationFont = AEGfxCreateFont("Assets/esamanru-Bold.ttf", 45);
	Level::StageBoss_Lvl::Stage2 = false;
}

void Level::Congratulation::Update()
{
	AEGfxPrint(CongratulationFont, "Congratulation!", 0.48f, 0.126f, 1.f, 1.f, 1.f, 1.f, 1.f);
	
	AEGfxPrint(CongratulationFont, "Press ESC Exit", 0.61f, 0.f, 0.5f, 1.f, 1.f, 1.f, 1.f);
